    ...
    <div>
        ...
        <div v-if="aboutType" class="aboutMask">
            <div class="aboutMes">
                ...
                <p>3. Click Play button after all finished.</p>
        ...
        <div class="appModule" ref="app">
            ...
            <div id="app">
                ...
                <ClassicalMusicalNote :moveAnType="moveAnType" :dotIndexList="dotList" @onChange="getAllPosition"/>
...
<script>
    ...
    import ClassicalMusicalNote from '../ClassicalMusicalNote/index'
